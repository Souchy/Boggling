...
export class Boggling {
	...
	constructor(private dictionary: Dictionary, private ea: IEventAggregator) {
		...
		this.ea.subscribe('wordSelected', (word: string) => {
	...
	public async play() {
		...
		// this.grid = BoardGenerator.generateRandomBoard(5);
		console.log(this.grid);
		let foundWords = BoardSolver.findWords(this.grid, this.dictionary.trie);
